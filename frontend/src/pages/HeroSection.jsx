...
function HeroSection({ onGetStarted }) {
  return (
    <>
      {/* ================= HERO ================= */}
      <section
        className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
      >
        {/* Background */}
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {[
              { icon: Globe, title: "Multi-Source", desc: "Scrapes Eenadu, Sakshi, Andhrajyothy" },
              { icon: Sparkles, title: "AI-Powered", desc: "IndicBART & TextRank" },
              { icon: Zap, title: "Voice Output", desc: "Text-to-Speech in Telugu" },
            ].map((feature) => (
              <div
                key={feature.title}
              ...
              >
                ...
                <div className="text-sm text-slate-400 dark:text-slate-500">{feature.desc}</div>
              </div>
            ))}
          </div>
        </motion.div>
  ...
  <div className="relative z-10 mx-auto max-w-5xl">
    ...
    <div className="grid gap-5">
      <ArchStep
        ...
        desc="BeautifulSoup scrapes Eenadu, Sakshi, Andhrajyothy."
      />
      ...
      <ArchStep
        ...
        desc="Indic NLP cleans and normalizes text."
      />

      <ArchStep
        step="03"
        icon="filter"
        title="Extractive Filter"
        desc="TextRank selects important sentences."
      />

      <ArchStep
        step="04"
        icon="brain"
        title="Abstractive Synthesis"
        desc="IndicBART rewrites summary naturally."
      />
      ...
      <ArchStep
        ...
        desc="gTTS converts text into audio."
      />
    </div>
